...
mod tests {
    ...
    fn test_calc_mach_from_mach_angle() {
        ...
        let mach_result = calc_mach_from_mach_angle(mach_angle);
        match mach_result {
            Ok(mach_number) => {
    ...
    fn test_calc_mach_from_temperature_ratio() {
        ...
        let mach_result = calc_mach_from_temperature_ratio(temperature_ratio, specific_heat_ratio);
        match mach_result {
            Ok(mach_number) => {
                println!(
    ...
    fn test_calc_mach_from_pressure_ratio() {
        ...
        let specific_heat_ratio = 1.4;
        let mach_result = calc_mach_from_pressure_ratio(pressure_ratio, specific_heat_ratio);
        match mach_result {
            Ok(mach_number) => {
                println!(
    ...
    fn test_calc_mach_from_density_ratio() {
        ...
        let specific_heat_ratio = 1.4;
        let mach_result = calc_mach_from_density_ratio(density_ratio, specific_heat_ratio);
        match mach_result {
            Ok(mach_number) => {
                dbg!(mach_number);
                println!(
    ...
    fn test_calc_mach_from_prandtl_meyer_angle() {
        ...
        let specific_heat_ratio = 1.4;
        let mach_result = calc_mach_from_prandtl_meyer_angle(prandtl_meyer_angle, specific_heat_ratio);
